SELECT region_id, land_area, eez_area, ts_area,
  ...
  (COALESCE(well_connected_area,0) / jrc_regional_area * 100) AS percentage_well_connected,
  (COALESCE(importance_area,0) / jrc_regional_area * 100) AS percentage_importance,
